...
public class PatientsWindow extends JFrame {
	...
	private void initialize() {
		...
		// Create components
		title = new JLabel("HASTA BILGISI");
		back = new JButton("< Geri");
		filterByName = new JLabel("Ad ve soyada gore filtrele");
		firstName = new JTextField();
		lastName = new JTextField();
		filterByGender = new JLabel("Cinsiyete gore filtrele:");
		filterByTckn = new JLabel("TCKN'ye gore filtrele:");
		tckn = new JTextField();
		...
		dash1 = new JLabel("-");
		filterByAge = new JLabel("Yasa gore filtrele:");
		filterByBloodType = new JLabel("Kan grubuna gore filtrele:");
		deletePatient = new JButton("Hastayi sil");
		createPatient = new JButton("Hasta ekle");
		maxAge = new JTextField();
		updatePatient = new JButton("Hasta bilgilerini guncelle");
		filterByCronicalIllnes = new JLabel("Kronik hastalara gore filtrele:");
		...
		filterByStatus = new JLabel("Durumuna gore filtrele");
		status = new JComboBox<String>();
		hospital = new JTextField();
		filterByHospital = new JLabel("Muayene oldugu hastaneye gore filtrele:");
		slash1 = new JLabel("/");
